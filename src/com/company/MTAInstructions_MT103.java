...
public class MTAInstructions_MT103 {
    public static void main(String[] args) throws Exception {
        String path = "C:\\Users\\teuta\\Desktop\\Regression\\generateMT\\src\\test\\resources\\mtFiles\\MTAInstructions_MT103_Template.txt";
        ...
        String ref = String.format("ALTB103%03dTK", number);
        ...
        if(sc.hasNext("^[0-9,]+$")) {
            ...
            if(sc.hasNext("[a-zA-Z]{3}")) {
                ...
                if(sc.hasNext("[a-zA-Z0-9]{11}")) {
                    ...
                    String newFilePath = "C:\\Users\\teuta\\Desktop\\Regression\\generateMT\\src\\test\\resources\\mtFiles\\generatedPayments\\IncomingPayments\\Alternative Instructions\\MT103\\MT103_FBE_" + nameConventionForMT1.format(calendar.getTime()) + "." + nameConventionForMT2.format(calendar.getTime()) + ".000.mt";
