...
public class MT199_CTC1X_Fin2TPH {
    public static void main(String[] args) throws Exception {
        String path = "C:\\Users\\teuta\\Desktop\\Regression\\generateMT\\src\\test\\resources\\mtFiles\\MT199_CTC1X_Fin2TPH_Template.txt";
        ...
        String ref = String.format("%04d", number);

        Random rnd_1 = new Random();
        int number_1 = rnd_1.nextInt(999);
        String ref_1 = String.format("%04d", number_1);

        Scanner sc = new Scanner(System.in);
        System.out.println("Please input amount with a decimal vaule: ");
        String amount;
        if(sc.hasNext("^[0-9,]+$")) {
            amount = sc.nextLine();
            ...
            if(sc.hasNext("[a-zA-Z]{3}")) {
                ...
                String newFilePath = "C:\\Users\\teuta\\Desktop\\Regression\\generateMT\\src\\test\\resources\\mtFiles\\generatedPayments\\IncomingPayments\\Fin2TPH\\MT199_FBE_" + nameConventionForMT1.format(calendar.getTime()) + "." + nameConventionForMT2.format(calendar.getTime()) + ".000.mt";
