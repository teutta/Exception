...
public class MT_Return {
    public static void main(String[] args) throws Exception {
        String path = "C:\\Users\\teuta\\Desktop\\Regression\\generateMT\\src\\test\\resources\\mtFiles\\MT_Return_Template.txt";
        ...
        String ref = String.format("%05d", number);
