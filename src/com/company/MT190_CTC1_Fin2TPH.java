...
public class MT190_CTC1_Fin2TPH {
    public static void main(String[] args) throws Exception {
        String path = "C:\\Users\\HT\\Desktop\\Regression\\Regression\\generateMT\\src\\test\\resources\\mtFiles\\MT190_CTC1_Fin2TPH_Template.txt";
        ...
        if(sc.hasNext("^[0-9,]+$")) {
            ...
            if(sc.hasNext("[a-zA-Z]{3}")) {
                ...
                System.out.println("Your specified currency: " + currency);
                    ...
                    String newFilePath = "C:\\Users\\HT\\Desktop\\Regression\\Regression\\generateMT\\src\\test\\resources\\mtFiles\\generatedPayments\\IncomingPayments\\Fin2TPH\\MT190_FBE_" + nameConventionForMT1.format(calendar.getTime()) + "." + nameConventionForMT2.format(calendar.getTime()) + ".000.mt";
