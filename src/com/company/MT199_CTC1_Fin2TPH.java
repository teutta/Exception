...
public class MT199_CTC1_Fin2TPH {
    public static void main(String[] args) throws Exception {
        String path = "C:\\Users\\teuta\\Desktop\\Regression\\generateMT\\src\\test\\resources\\mtFiles\\MT199_CTC1_Fin2TPH_Template.txt";
        ...
        String ref = String.format("%01d", number);
        ...
        if(sc.hasNext("^[0-9,]+$")) {
            ...
            if(sc.hasNext("[a-zA-Z]{3}")) {
                ...
                String newFilePath = "C:\\Users\\teuta\\Desktop\\Regression\\generateMT\\src\\test\\resources\\mtFiles\\generatedPayments\\IncomingPayments\\Fin2TPH\\VAL\\MT199_FBE_" + nameConventionForMT1.format(calendar.getTime()) + "." + nameConventionForMT2.format(calendar.getTime()) + ".000.mt";
